                        ...
                        <div>
                            <h3 class="box-title m-b-0 float-left">
                                <button class="btn btn-primary" data-toggle="modal" data-target="#responsive-modal"><i
                                        class="fa fa-plus"></i> Tambah Dokter</button>
                            </h3>
                        </div>
                       <!-- /.end Button Tambah Dokter-->
                            ...
                            <table id="myTable" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$item->alamat}}</td>
                                        <td>
                                            <a href="{{route('manajemen.dokter.delete', $item->id)}}">
